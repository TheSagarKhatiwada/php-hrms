...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $sql = "INSERT INTO employees (emp_id, mach_id, branch, first_name, middle_name, last_name, email, phone, join_date, user_image)
          VALUES (:empId, :machId, :empBranch, :empFirstName, :empMiddleName, :empLastName, :empEmail, :empPhone, :empJoinDate, :userImage)";
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
     ...
     <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <form id="addUserForm" method="POST" action="add-user.php" enctype="multipart/form-data">
                  <div class="row">
                    <div class="col-md-4">
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group">
                            <input type="text" class="form-control" id="empId" name="empId" placeholder=" " required value="<?php echo htmlspecialchars($empId); ?>" disabled>
                            <label for="empId" class="form-label">ID <span style="color:red;">*</span>(Auto Generated)</label>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group">
                            <input type="text" class="form-control" id="machId" name="machId" placeholder=" " value="<?php echo htmlspecialchars($machId); ?>">
                            <label for="machId" class="form-label">Machine ID</label>
                          </div>
                        </div>
                      </div>
                      <div class="form-group">
                        <input type="text" class="form-control" id="empFirstName" name="empFirstName" placeholder=" " required value="<?php echo htmlspecialchars($empFirstName); ?>">
                        <label for="empFirstName" class="form-label">First Name <span style="color:red;">*</span></label>
                      </div>
                      <div class="form-group">
                        <input type="text" class="form-control" id="empMiddleName" name="empMiddleName" placeholder=" " value="<?php echo htmlspecialchars($empMiddleName); ?>">
                        <label for="empMiddleName" class="form-label">Middle Name</label>
                      </div>
                      <div class="form-group">
                        <input type="text" class="form-control" id="empLastName" name="empLastName" placeholder=" " required value="<?php echo htmlspecialchars($empLastName); ?>">
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        <input type="text" class="form-control" id="empBranch" name="empBranch" placeholder=" " required value="<?php echo htmlspecialchars($empBranch); ?>">
                      ...
                      <div class="form-group">
                        <input type="text" class="form-control" id="designation" name="designation" placeholder=" " required value="<?php echo htmlspecialchars($designation); ?>">
                        <label for="designation" class="form-label">Designation <span style="color:red;">*</span></label>
                      </div>
                      <div class="form-group">
                        <input type="text" class="form-control" id="empStatus" name="empStatus" placeholder=" " required disabled value="Working">
                        <label for="empStatus" class="form-label">Working Status <span style="color:red;">*</span></label>
                      </div>
                      <div class="form-group">
                        <input type="date" class="form-control" id="empExitDate" name="empExitDate" placeholder=" " min="<?php echo date('Y-m-d', strtotime('-30 days')); ?>" max="<?php echo date('Y-m-d', strtotime('15 days')); ?>">
                        <label for="empExitDate" class="form-label">Exit Date</label>
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="form-group">
                        <img id="photoPreview" src="<?php echo $home;?>resources/userimg/default-image.jpg" alt="Photo Preview" style="max-width: 50%; display: block; border: 1px solid #ccc; border-radius: 5px;">
                      </div>
                      <div class="form-group">
