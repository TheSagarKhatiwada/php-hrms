...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['action'])) {
        ...
        if ($action == 'add') {
            ...
            try {
                // Update maintenance status to In Progress and save notes
            ...
            try {
                ...
                $stmt = $pdo->prepare("UPDATE AssetMaintenance 
                                     SET MaintenanceStatus = 'Not Required', 
              ...
              <tr>
                ...
                <td class="align-middle">
                  ...
                  <?php if ($record['MaintenanceStatus'] == 'Completed'): ?>
                    <div>
                      <span class="fw-medium">Act: </span>Rs. <?php echo number_format($record['ActualCost'], 2); ?>
                    </div>
                  <?php endif; ?>
                </td>
                <td class="text-center align-middle">
                  ...
                  <?php elseif ($record['MaintenanceStatus'] == 'Not Required'): ?>
                ...
                <td class="text-center align-middle">
                  <?php if ($record['MaintenanceStatus'] == 'Completed' || $record['MaintenanceStatus'] == 'Not Required'): ?>
