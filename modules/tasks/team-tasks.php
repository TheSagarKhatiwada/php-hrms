            ...
            <?php else: ?>
                <div class="table-responsive">
                    <table class="table table-hover align-middle mb-0" id="teamTasksTable">
                                <thead class="table-header-adaptive">
                                    <tr>
...
/* Adaptive table header for light/dark mode */
.table-header-adaptive th {
    background: var(--table-header-bg, #fff);
    color: var(--table-header-color, #222);
    border-bottom: 2px solid #dee2e6;
}

body.dark-mode .table-header-adaptive th {
    --table-header-bg: #222;
