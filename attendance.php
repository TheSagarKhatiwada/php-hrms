    ...
    <section class="content">
     <div class="container-fluid">
      <div class="card">
        ...
        <!-- /.card-header -->
        <div class="card-body">
          <table id="attendance-table" class="table table-bordered table-striped" width="100%">
            <thead>
              <tr>
            ...
            <tbody>
              <?php 
                foreach ($attendanceRecords as $record) {
                  ...
                  echo "<td class='align-items-center text-center'>{$record['branch']}</td>";
            ...
            <div class="card card-primary card-outline card-outline-tabs">
              <div class="card-header p-0 border-bottom-0">
                <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
                  <li class="nav-item">
                    <a class="nav-link active" id="custom-tabs-four-home-tab" data-toggle="pill" href="#custom-tabs-four-home" role="tab" aria-controls="custom-tabs-four-home" aria-selected="true">Manual</a>
                  </li>
                  <li class="nav-item">
              ...
              <div class="card-body">
                <div class="tab-content" id="custom-tabs-four-tabContent">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-12">
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              <input type="date" class="form-control" id="Attendance" name="Attendance" placeholder=" " value="<?php echo date('Y-m-d'); ?>" min="<?php echo date('Y-m-d', strtotime('-30 days')); ?>" max="<?php echo date('Y-m-d'); ?>" required>
                  ...
                  <button type="submit" form="addAttendanceForm" class="btn btn-primary">Save Attendance</button>
                </form>
                  </div>
                ...
                <div class="col-md-9">
                  <form action="upload-attendance.php" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                      ...
                      <label for="attendanceFile" class="form-label">Upload Attendance File</label>
                    </div>
                </div>
                <div class="col-md-3">
